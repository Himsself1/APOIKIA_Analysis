...
metadata <- read.table(
  file = "~/apoikia/APOIKIA_Analysis/qpadm_after_revisions/metadata_qpadm/qpAdm_most_proximate_model_tenea_roman_model1.tsv",
...
write.table(
  qpwave_pairs_out,
  "~/apoikia/qpadm_results/qpwave_results/qpwave_pairs_most_proximate_tenea_roman.tsv",
  quote = F, sep = '\t', row.names = F
)

write.table(
  qpwave_high_pvalues,
  "~/apoikia/qpadm_results/qpwave_results/qpwave_pairs_most_proximate_tenea_roman_high_pvalues.tsv",
  quote = F, sep = '\t', row.names = F
)
