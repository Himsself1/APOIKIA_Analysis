...
PATH_TO_FAMILY_FILE="/home/aggeliki/apoikia/APOIKIA_Analysis/admixture_analysis/family_to_remove_yoruba_han.tsv"

mkdir -p $PATH_TO_TRIMMED
# * Converts eigenstrat to .ped

~/apoikia/APOIKIA_Analysis/convertf -p ~/apoikia/APOIKIA_Analysis/admixture_analysis/apoikia_25_27_2025_to_plink.parfile
...
plink1.9 --ped $PATH_TO_INPUT/apoikia.1240K.ANCIENT_plus_Yoruba_Han.ped \
	 ...
	 --out $PATH_TO_INPUT/apoikia.1240K.ANCIENT_plus_Yoruba_Han_maf_005_no_relatives
...
plink1.9 --bfile $PATH_TO_INPUT/apoikia.1240K.ANCIENT_plus_Yoruba_Han_maf_005_no_relatives \
