...
PATH_TO_TRIMMED="/home/aggeliki/apoikia/EIGENSTRAT/dataset_25_27_2025/APOIKIA_PLUS_PUBLIC_ANCIENT_PLUS_OUTGROUPS/trimmed_data_maf_005_no_relatives"
PATH_TO_OUTPUT="/home/aggeliki/apoikia/admixture_logs/dataset_25_27_2025/haploid_no_paleo"
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.trimmed.bed ",
    i
  ), collapse = "")
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.trimmed.geno_08.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.trimmed.geno_06.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.trimmed.geno_04.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for (i in 1:length(admixture_output_names)) {
  cmd <- noquote(paste0(c(
    ...
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_08)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.geno_08.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_06)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.geno_06.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_04)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_08.geno_04.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.trimmed.bed ",
    i
  ), collapse = '')
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.trimmed.geno_08.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.trimmed.geno_06.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.trimmed.geno_04.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
##     " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
##     ## R needs to escape the escape character ('\') in order ot print it
##     " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.trimmed.csv"
##   ), collapse = ""))
##   system(cmd)
## }
...
for (i in 1:length(admixture_output_names_geno_08)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.geno_08.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_06)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.geno_06.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_04)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_06.geno_04.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.trimmed.bed ",
    i
  ), collapse = '')
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.trimmed.geno_08.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.trimmed.geno_06.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
for(i in 2:cores){
  temp_input <- paste0(c(
    PATH_TO_TRIMMED,
    "/apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.trimmed.geno_04.bed ",
    i
  ), collapse = "")
  temp_output <- paste0(c(
    PATH_TO_OUTPUT,
...
##     admixture_output_names[i],
##     " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
##     ## R needs to escape the escape character ('\') in order to print it
##     " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.trimmed.csv"
##   ), collapse = ""))
##   system(cmd)
## }
...
for (i in 1:length(admixture_output_names_geno_08)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.geno_08.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_06)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.geno_06.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
...
for (i in 1:length(admixture_output_names_geno_04)) {
  cmd <- noquote(paste0(c(
    ...
    " | awk '{print $3 $4}' | sed 's/(K=\\([0-9]*\\)):\\([0-9]\\.[0-9]*\\)/\\1,\\2/g'",
    ## R needs to escape the escape character ('\') in order ot print it
    " >> CV_errors_apoikia.1240K.ANCIENT_plus_Yoruba_Han.LD_200_25_04.geno_04.trimmed.csv"
  ), collapse = ""))
  system(cmd)
}
