...
save_statistics(f3_ammotopos, "~/apoikia/f3_outputs/f3_results/f3_ammotopos_updated_labels.tsv")
save_statistics(f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/f3_amv_archaic_updated_labels.tsv")
save_statistics(f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_roman_updated_labels.tsv")
save_statistics(f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/f3_tenea_archaic_updated_labels.tsv")
save_statistics(f3_tenea_early_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_early_roman_updated_labels.tsv")
save_statistics(f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/f3_amv_classical_updated_labels.tsv")
save_statistics(f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/f3_amv_hellenistic_updated_labels.tsv")

save_statistics(ind_f3_ammotopos, "~/apoikia/f3_outputs/f3_results/ind_f3_ammotopos_updated_labels.tsv")
save_statistics(ind_f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_archaic_updated_labels.tsv")
save_statistics(ind_f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/ind_f3_tenea_roman_updated_labels.tsv")
save_statistics(ind_f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_classical_updated_labels.tsv")
save_statistics(ind_f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_hellenistic_updated_labels.tsv")
...
save_statistics(f3_ammotopos, "~/apoikia/f3_outputs/f3_results/f3_ammotopos_han_updated_labels.tsv")
save_statistics(f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/f3_amv_archaic_han_updated_labels.tsv")
save_statistics(f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_roman_han_updated_labels.tsv")
save_statistics(f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/f3_tenea_archaic_han_updated_labels.tsv")
save_statistics(f3_tenea_early_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_early_roman_han_updated_labels.tsv")
save_statistics(f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/f3_amv_classical_han_updated_labels.tsv")
save_statistics(f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/f3_amv_hellenistic_han_updated_labels.tsv")

save_statistics(ind_f3_ammotopos, "~/apoikia/f3_outputs/f3_results/ind_f3_ammotopos_han_updated_labels.tsv")
save_statistics(ind_f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_archaic_han_updated_labels.tsv")
save_statistics(ind_f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/ind_f3_tenea_roman_han_updated_labels.tsv")
save_statistics(ind_f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_classical_han_updated_labels.tsv")
save_statistics(ind_f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_hellenistic_han_updated_labels.tsv")
