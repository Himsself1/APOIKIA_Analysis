...
save_statistics(f3_ammotopos, "~/apoikia/f3_outputs/f3_results/f3_ammotopos_han.tsv")
save_statistics(f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/f3_amv_archaic_han.tsv")
save_statistics(f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_roman_han.tsv")
save_statistics(f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/f3_tenea_archaic_han.tsv")
save_statistics(f3_tenea_early_roman, "~/apoikia/f3_outputs/f3_results/f3_tenea_early_roman_han.tsv")
save_statistics(f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/f3_amv_classical_han.tsv")
save_statistics(f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/f3_amv_hellenistic_han.tsv")

save_statistics(ind_f3_ammotopos, "~/apoikia/f3_outputs/f3_results/ind_f3_ammotopos_han.tsv")
save_statistics(ind_f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_archaic_han.tsv")
save_statistics(ind_f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/ind_f3_tenea_roman_han.tsv")
save_statistics(ind_f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_classical_han.tsv")
save_statistics(ind_f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/ind_f3_amv_hellenistic_han.tsv")
...
png("~/apoikia/f3_outputs/plots/f3_ammotopos_han.png", height = 1024, width = 860)
plot_ammotopos
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_arch_han.png", height = 1024, width = 860)
plot_amv_archaic
dev.off()

png("~/apoikia/f3_outputs/plots/f3_tenea_arch_han.png", height = 1024, width = 860)
plot_tenea_archaic
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_class_han.png", height = 1024, width = 860)
plot_amv_classical
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_hel_han.png", height = 1024, width = 860)
plot_amv_hellenistic
dev.off()

png("~/apoikia/f3_outputs/plots/f3_tenea_early_roman_han.png", height = 1024, width = 860)
plot_tenea_early_roman
dev.off()

png("~/apoikia/f3_outputs/plots/f3_tenea_roman_han.png", height = 1024, width = 860)
plot_tenea_roman
dev.off()

# *** Individual + Population Plots

png("~/apoikia/f3_outputs/plots/f3_ammotopos_with_indiduals_han.png", height = 1024, width = 1080)
inds_plot_ammotopos
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_arch_with_indiduals_han.png", height = 1024, width = 1080)
inds_plot_amv_archaic
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_class_with_indiduals_han.png", height = 1024, width = 1080)
inds_plot_amv_classical
dev.off()

png("~/apoikia/f3_outputs/plots/f3_amv_hel_with_indiduals_han.png", height = 1024, width = 1080)
inds_plot_amv_hellenistic
dev.off()

png("~/apoikia/f3_outputs/plots/f3_tenea_roman_with_indiduals_han.png", height = 1024, width = 1080)
inds_plot_tenea_roman
dev.off()
