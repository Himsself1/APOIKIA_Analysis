...
flags <- read.table("/home/aggeliki/apoikia/APOIKIA_Analysis/scripts_for_f4/Updated_Labels_for_f3_25_07_2025.csv",
  sep = ",", header = T, na.strings = c("NA", "")
)

## indexes_of_flags_to_ignore <- which(flags$Genetic_ID %in% individuals_to_ignore)

han_output <- "~/apoikia/f3_outputs/plots/dataset_25_27_2025/han_outgroup"
yoruba_output <- "~/apoikia/f3_outputs/plots/dataset_25_27_2025/yoruba_outgroup"

## Create the output directory
## dir.create("~/apoikia/f3_outputs/plots/dataset_04_05_2024/", recursive = F)
dir.create(han_output, recursive = T)
dir.create(yoruba_output, recursive = T)
dir.create("~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/", recursive = T)
dir.create("~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup", recursive = T)
dir.create("~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup", recursive = T)
...
pop3 <- grep("NO|Ammotopos*|Yoruba|Han", unique(flags$Ammotopos.1275.1125BCE.), value = TRUE, invert = TRUE)
...
pop3 <- grep("NO|Amvrakia_Archaic*|Yoruba|Han", unique(flags$Archaic.550.480BCE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
pop3 <- grep("NO|Tenea_Archaic*|Yoruba|Han", unique(flags$Archaic.550.480BCE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
pop3 <- grep("NO|Amvrakia_Classical*|Yoruba|Han", unique(flags$Classical.475.325BCE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
pop3 <- grep("NO|Amvrakia_Hellenistic*|Yoruba|Han", unique(flags$Hellenistic.325.100BCE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
pop1 <- "Yoruba"
pop2 <- "GRC_Tenea_Hellenistic_323-31BCE"
## pop3 needs to not include ammotopos and NO populations
pop3 <- grep("NO|Tenea_Hellenistic*|Yoruba|Han", unique(flags$Hellenistic.325.100BCE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
## pop3 needs to not include ammotopos and NO populations
pop3 <- grep("NO|Tenea_LHellenistic*|Yoruba|Han", unique(flags$Roman.31BCE.330CE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
pop3 <- grep("NO|Tenea_Roman*|Yoruba|Han", unique(flags$Roman.31BCE.330CE.), value = TRUE, invert = TRUE)
all_combinations <- expand.grid(
  "pop1" = pop1, "pop2" = pop2, "pop3" = pop3[!is.na(pop3)],
  stringsAsFactors = F
)
...
save_statistics(f3_ammotopos, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_ammotopos.tsv")
save_statistics(f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_amv_archaic.tsv")
save_statistics(f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_tenea_roman.tsv")
save_statistics(f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_tenea_archaic.tsv")
save_statistics(f3_tenea_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_tenea_hellenistic.tsv")
save_statistics(f3_tenea_early_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_tenea_early_roman.tsv")
save_statistics(f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_amv_classical.tsv")
save_statistics(f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/f3_amv_hellenistic.tsv")

save_statistics(ind_f3_ammotopos, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_ammotopos.tsv")
save_statistics(ind_f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_amv_archaic.tsv")
save_statistics(ind_f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_tenea_archaic.tsv")
save_statistics(ind_f3_tenea_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_tenea_hellenistic.tsv")
save_statistics(ind_f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_tenea_roman.tsv")
save_statistics(ind_f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_amv_classical.tsv")
save_statistics(ind_f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/yoruba_outgroup/ind_f3_amv_hellenistic.tsv")
...
save_statistics(f3_ammotopos, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_ammotopos_han.tsv")
save_statistics(f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_amv_archaic_han.tsv")
save_statistics(f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_tenea_roman_han.tsv")
save_statistics(f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_tenea_archaic_han.tsv")
save_statistics(f3_tenea_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_tenea_hellenistic_han.tsv")
save_statistics(f3_tenea_early_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_tenea_early_roman_han.tsv")
save_statistics(f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_amv_classical_han.tsv")
save_statistics(f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/f3_amv_hellenistic_han.tsv")

save_statistics(ind_f3_ammotopos, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_ammotopos_han.tsv")
save_statistics(ind_f3_amv_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_amv_archaic_han.tsv")
save_statistics(ind_f3_tenea_archaic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_tenea_archaic_han.tsv")
save_statistics(ind_f3_tenea_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_tenea_hellenistic_han.tsv")
save_statistics(ind_f3_tenea_roman, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_tenea_roman_han.tsv")
save_statistics(ind_f3_amvrakia_classical, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_amv_classical_han.tsv")
save_statistics(ind_f3_amvrakia_hellenistic, "~/apoikia/f3_outputs/f3_results/dataset_25_27_2025/han_outgroup/ind_f3_amv_hellenistic_han.tsv")
